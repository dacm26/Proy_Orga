...
public:
    ...
    bool insert (string, int); //metodo de insercion
    int remove (string); //metodo de eliminacion de llaves
    int search_Key (BNode*,string); //busca la llave a partir de un nodo y retorna el rrn
